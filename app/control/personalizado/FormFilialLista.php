...
class FormFilialLista extends TStandardFormList{
    protected $form;
    protected $form2;
    protected $form3;
    protected $datagrid;
...
//        $lb_empresa = new TLabel('Empresa');
        ...
        //Grid
        $grid = new TQuickGrid();
        $grid->addQuickColumn('Codigo', 'id', 'left', 50, $btnRecarregar, array('order','id'));
        $grid->addQuickColumn('Empresa', 'mostrarEmpresa', 'left', null, $btnRecarregar, array('order','empresa_id'));
        $grid->addQuickColumn('Cnpj', 'cnpj', 'left', null, $btnRecarregar, array('order','cnpj'));
        $grid->addQuickColumn('IE', 'ie', 'left', null, $btnRecarregar, array('order','ie'));
